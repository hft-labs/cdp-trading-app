...
import { CheckboxField, DateField, InputField, TextAreaField } from "@/components/form-fields";
  ...
  switch (props.description.type) {
    case 'string': {
      if (props.description.meta?.type === "textarea") {
        return <TextAreaField {...usualProps as any} />;
      } else {
        return <InputField {...usualProps as any} />;
      }
    }
    case 'date': {
      return <DateField {...usualProps as any} />;
    }
    case 'boolean': {
      return <CheckboxField {...usualProps as any} />;
    }
  }
